...
def run_test_largest_number():
    ...
    # Test 5:
    expected = 9
    answer = largest_number([(-33, -11, -4),(),(),[2, 5, 6, 9]])
    print('Expected and actual are:', expected, answer)
...
def run_test_largest_negative_number():
    ...
    # Test 1:
    expected = -2.6
    answer = largest_negative_number([(30,-5,8,-20),(100,-2.6,88,-40),(400, 500)])
    print('Expected and actual are:', expected, answer)

    # Test 2
    expected = None
    answer = largest_negative_number([(49,58,40,10),(6,54,94)])
    print('Expected and actual are:', expected, answer)
